...
import static com.bookstore.book.constants.ResourceUrl.BOOKS_PRICE_BY_ID;
...
import com.bookstore.book.constants.ResourceUrl;
...
public class BookWebService {
	...
	@GetMapping(value = BOOKS_PRICE_BY_ID)
	public BigDecimal retrievePriceById(@PathVariable Long id) {
		log.info("Entered inside Webservice Layer, Service => find All books ");
		return bookService.retrievePriceById(id);
	}
